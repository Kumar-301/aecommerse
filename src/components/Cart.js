          ...
          <tbody>
            {details.map(items=>(
              ...
              <tr className='borders' key={items.id}>
                ...
                <td><button className='btn bg-danger text-white' onClick={()=>deleteCart(items.id)}>Delete</button></td>
              </tr>
              ))}
              <tr>
              <td></td>
              ...
              <td></td>
              <td><Link to="/checkout" className='btn bg-success text-white'>Checkout</Link></td>
              <td></td>
            </tr>
          </tbody>
        </table>
