    ...
    <div>
        ...
        <div>
            ...
            <form onSubmit={logintoaccount}>
                <div >
                    <input type="email" className='w-100 my-2 p-1' name='email' placeholder='Enter Email' onChange={addItem}/>
                    <p className='text-danger'>{state.emailErr}</p>
                </div>
                <div>
                    <input type="password" className='w-100 my-2 p-1' name='password' placeholder='Enter Password' onChange={addItem}/>
