    ...
    <div>
        ...
        <div>
            ...
            <div className='form-group'>
                ...
                <input id='pname' type="text" name='username' className='w-100 my-2 p-1' onChange={addItem}/>
                <p className='text-danger'>{state.userErr}</p>
            </div>
            <div className='form-group'>
                <label htmlFor="email">Email</label>
                <input id='email' type="email" name='mail' className='w-100 my-2 p-1' onChange={addItem}/>
                <p className='text-danger'>{state.mailErr}</p>
            </div>
            <div className='form-group'>
                <label htmlFor="pass">Password</label>
                <input id='pass' type="password" name='password' className=' w-100 my-2 p-1' onChange={addItem}/>
                <p className='text-danger'>{state.pwdError}</p>
            </div>
            <div className='form-group'>
                <label htmlFor="conpass">Confirm Password</label>
                <input id='conpass' type="password" name='confirmPwd' className='w-100 my-2 p-1' onChange={addItem}/>
